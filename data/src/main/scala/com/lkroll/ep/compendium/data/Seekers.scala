...
object Seekers {
  ...
  val seekerArmband = Weapon(
    ...
    descr =
      "This weapons unit is worn on the arm, allowing the user to point and fire using an entoptic smartlink system. Though highly portable, the armband’s micromissile supply is low. It fires in single-shot mode.",
    damage = (0.d10 + 0),
    effect = None,
    ap = 0,
    price = Cost.Moderate,
    range = Range.Ranged(70, 180, 600, 2000),
    gun = GunExtras(modes = Set(SS), magazineSize = 4),
    source = Sources.ep
  );
  ...
  val seekerPistol = Weapon(
    ...
    price = Cost.Moderate,
    range = Range.Ranged(70, 180, 600, 2000),
    gun = GunExtras(modes = Set(SA), magazineSize = 8),
    source = Sources.ep
  );
  ...
  val seekerRifleMicro = Weapon(
    ...
    `type` = WeaponType.Seeker(Micromissile),
    descr =
      "The seeker rifle comes in a bullpup configuration and fires either micromissiles or minimissiles in semi-auto mode. It is a two-handed weapons.",
    damage = (0.d10 + 0),
    effect = None,
    ap = 0,
    price = Cost.High,
  ...
  val seekerRifleMini = Weapon(
    ...
    gun = GunExtras(modes = Set(SA), magazineSize = 6),
    source = Sources.ep
  );
