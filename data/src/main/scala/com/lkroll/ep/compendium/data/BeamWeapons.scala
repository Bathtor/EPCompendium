...
object BeamWeapons {
  ...
  val laserPulser = Weapon(
    ...
    gun = GunExtras(modes = Set(SA), magazineSize = 100),
    source = Sources.ep
  );
  ...
  val laserPulserStun = Weapon(
    ...
    damage = (1.d10 + 0).energy,
    effect = Some("Stun"),
    ap = 0,
    price = Cost.Moderate,
    range = Range.Ranged(30, 100, 150, 250),
    gun = GunExtras(modes = Set(SS), magazineSize = 100),
    source = Sources.ep
  );
  ...
  val agonizerRoast = Weapon(
    ...
    price = Cost.Moderate,
    range = Range.Ranged(5, 15, 30, 50),
    gun = GunExtras(modes = Set(SS), magazineSize = 50),
    source = Sources.ep
  );
  ...
  val plasmaRifle = Weapon(
    ...
    damage = (3.d10 + 20).energy,
    effect = Some("Burn"),
    ap = -8,
    price = Cost.Expensive,
    range = Range.Ranged(20, 50, 100, 300),
    gun = GunExtras(modes = Set(SA), magazineSize = 10),
    source = Sources.ep
  );
  ...
  val stunner = Weapon(
    ...
    damage = (1.d10 / 2 + 0).energy,
    effect = Some("Shock"),
    ap = 0,
    price = Cost.Moderate,
    range = Range.Ranged(10, 25, 40, 60),
    gun = GunExtras(modes = Set(SA), magazineSize = 200),
    source = Sources.ep
  );
