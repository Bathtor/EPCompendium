...
object TraitsPanopticon {
  ...
  val impairedBalance1 = EPTrait(
    ...
    applicability = Ego,
    descr =
      "This trait is only available to neo-pigs. This uplift’s brain has not been fully adapted to the neo-pig’s bipedal stance and still suffers occasional difficulties with balance. The character suffers a −10 modifier to any Climbing, Freerunning, or similar test involving balance or upright movement.",
    cp = 10,
    source = Sources.panopticon,
    sourcePage = 145
  );
  ...
  val impairedBalance2 = EPTrait(
    ...
    applicability = Ego,
    descr =
      "This trait is only available to neo-pigs. This uplift’s brain has not been fully adapted to the neo-pig’s bipedal stance and still suffers occasional difficulties with balance. The character suffers a −20 modifier to any Climbing, Freerunning, or similar test involving balance or upright movement.",
    cp = 20,
    source = Sources.panopticon,
    sourcePage = 145
  );
  ...
  val impairedBalance3 = EPTrait(
    ...
    applicability = Ego,
    descr =
      "This trait is only available to neo-pigs. This uplift’s brain has not been fully adapted to the neo-pig’s bipedal stance and still suffers occasional difficulties with balance. The character suffers a −30 modifier to any Climbing, Freerunning, or similar test involving balance or upright movement.",
    cp = 30,
    source = Sources.panopticon,
    sourcePage = 145
  );
