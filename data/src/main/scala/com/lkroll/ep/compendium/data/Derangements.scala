...
object Derangements {
  ...
  val blackout = Derangement(
    name = "Blackout",
    severity = Major,
    descr = "You operate on auto-pilot in a temporary fugue state. Later, you will be incapable of recalling what happened during this period. (Synthetic shells and infomorphs may call up memory records from storage.)",
    source = Sources.ep,
    sourcePage = 211);

  val frenzy = Derangement(
    name = "Frenzy",
    severity = Major,
  ...
  val hallucinations = Derangement(
    name = "Hallucinations",
    severity = Major,
  ...
  val hysteria = Derangement(
    name = "Hysteria",
    severity = Major,
    descr = "You lose control, panicking over the source of the stress. This typically results in an emotional outburst of crying, laughing, or irrational fear.",
    source = Sources.ep,
    sourcePage = 211);
  ...
  val irrationality = Derangement(
    name = "Irrationality",
    severity = Major,
    descr = "You are so jarred by the stress that your capacity for logical judgment breaks down. You are angered by imaginary offenses, hold unreasonable expectations, or otherwise accept things with unconvincing evidence.",
    source = Sources.ep,
    sourcePage = 211);
  ...
  val paralysis = Derangement(
    name = "Paralysis",
    severity = Major,
    descr = "You are so shocked by the trauma that you are effectively frozen, incapable of making decisions or taking action.",
    source = Sources.ep,
    sourcePage = 211);
  ...
  val psychosoma = Derangement(
    ...
    severity = Major,
    descr = "The trauma overwhelms you, impairing some part of your physical functioning. You suffer from an inex- plicable blindness, deafness, or phantom pain or are suddenly incapable of using a limb or other extremity.",
    source = Sources.ep,
    sourcePage = 211);
  ...
  val confusion = Derangement(
    name = "Confusion",
    severity = Moderate,
    descr = "The trauma scrambles your concentration, making you forget what you’re doing, mix up simple tasks, and falter over easy decisions.",
  ...
  val narcissism = Derangement(
    name = "Narcissism",
    severity = Moderate,
    descr = "In the wake of the mental shock, all you can think about is yourself. You cease caring about those around you.",
  ...
  val panic = Derangement(
    name = "Panic",
    severity = Moderate,
    descr = "You are overwhelmed by fear or anxiety and immediately seek to distance yourself from the cause of the stress.",
  ...
  val anxiety = Derangement(
    name = "Anxiety",
    severity = Minor,
    descr = "You suffer a panic attack, exhibiting the physiological conditions of fear and worry: sweatiness, racing heart, trembling, shortness of breath, headaches, and so on.",
  ...
  val avoidance = Derangement(
    name = "Avoidance",
    severity = Minor,
    descr = "You are psychologically incapable of dealing with the source of the stress or some circumstance related to it, so you avoid it – even covering your ears, curling up in a ball, or shutting off your sensors if you have to.",
  ...
  val fixation = Derangement(
    name = "Fixation",
    severity = Minor,
    descr = "You become fixated on something that you did wrong or some circumstance that led to your stress. You obsess over it, repeating the behavior, trying to fix it, running scenarios through your head and out loud, and so on.",
  ...
  val hunger = Derangement(
    name = "Hunger",
    severity = Minor,
    descr = "You are suddenly consumed by an irrational yet overwhelming desire to eat something—perhaps even something unusual.",
  ...
  val indecisiveness = Derangement(
    name = "Indecisiveness",
    severity = Minor,
    descr = "You are flustered by the cause of your stress, finding it difficult to make choices or select courses of action.",
    upgradesTo = List(mute.name, tremors.name),
    source = Sources.ep,
    sourcePage = 210);
