...
object SoftwarePlugins {
  ...
  val persistence = Software(
    name = "Persistence",
    descr =
      "This software makes it more difficult for the ego to be forcibly shut down when brainhacked. Apply an additional –10 modifier to the intruder’s Infosec Test (in addition to the standard –30 modifier for brain-hacking).",
    price = Cost.Low,
    source = Sources.transhuman,
    sourcePage = 140
  );
