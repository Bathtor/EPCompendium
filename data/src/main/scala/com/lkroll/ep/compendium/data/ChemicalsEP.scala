...
object ChemicalsEP {
  ...
  val atropine = Substance(
    ...
    duration = "immediate",
    effects = List.empty,
    descr = "Though poisonous in large doses, atropine is an effective antidote against nerve agents like BTX2 and Nervex. Easily synthesized in a maker, atropine will avert the effect whether taken soon before or after dosage by a nerve agent.",
    price = Cost.Trivial,
    source = Sources.ep,
    sourcePage = 323);
  ...
  val dmso = Substance(
    ...
    duration = "immediate",
    effects = List.empty,
    descr = "This chemical acts as a carrier, allowing other chemicals to be absorbed through the skin. It allows any chemical agent to be applied dermally.",
    price = Cost.Trivial,
    source = Sources.ep,
    sourcePage = 323);
  ...
  val notWater = Substance(
    ...
    duration = "immediate",
    effects = List.empty,
    descr = "NotWater is an effective liquid fire retardant that does not get objects wet, no matter how absorbent they are—it simply beads up and slides right off.",
    price = Cost.Trivial,
    source = Sources.ep,
    sourcePage = 323);
  ...
  val scrapersGel = Substance(
    ...
    descr = "This goo turns into a potent acid when given an electrical charge. It comes in a gel-like state and may be smeared like jelly, and may even be used in space. In acid form, scrapper’s gel does 1d10 + 5 DV per Action Turn to anything it touches for 3 turns, unless the material has been treated against acid. Armor will protect against this acid at first, but the acid will eat through the armor, so that it will no longer protect after its full armor value has been reached.",
    price = Cost.Low,
    source = Sources.ep,
    sourcePage = 323);
