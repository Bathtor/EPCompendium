...
object MorphsTX {
  ...
  val takko = MorphModel(
    ...
    descr =
      "The first synthetic octopus design from the engineers at Feral Robot is a hardy shell custom-designed to make octopi uplifts feel more at home in a synthetic body with eight functioning appendages. Though it lacks ink sacs, the takko features vectored-thrust jets for micro-gravity propulsion.",
    enhancements = Seq(
      "360-Degree Vision",
      "Access Jacks",
      "Basic Mesh Inserts",
