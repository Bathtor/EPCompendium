...
object MorphsMN {
  ...
  val menton = MorphModel(
    ...
    morphType = Biomorph,
    descr =
      "Mentons are genetically modifed to increase cognitive abilities, particularly learning ability, creativity, attentiveness, and memory. Rumors exist of super-enhanced mentons with more extreme intelligence mods, but brainhacking is notoriously diffcult, and many attempts to redesign mental faculties result in impaired functioning, instability, or insanity.",
    enhancements =
      Seq("Basic Biomods", "Basic Mesh Inserts", "Cortical Stack", "Eidetic Memory", "Hyper Linguist", "Math Boost"),
    aptitudeMax = 30,
  ...
  val nautiloid = MorphModel(
    ...
    enhancements = Seq(
      ...
      "Internal Rocket",
      "Mnemonic Augmentation",
      "Pneumatic Limbs (2 of the Arms)",
      "Puppet Sock",
      "Radar",
      "Radiation Sense",
      "Swim Bladder",
      "Telescoping Limbs (2 of the Arms)",
      "T-Ray Emitter"
    ),
  ...
  val neoBeluga = MorphModel(
    ...
    enhancements =
      Seq("Basic Biomods", "Basic Mesh Inserts", "Cortical Stack", "Echolocation", "Enhanced Hearing", "Oxygen"),
  ...
  val neoGorilla = MorphModel(
    ...
    morphType = Biomorph,
    descr =
      "Neo-gorillas were uplifted in the same manner as the other neo-hominids and share the same characteristics, though they are not quite as adept at climbing. They stand roughly as tall as humans, though they have stronger and larger frames.",
  ...
  val neoPorpoise = MorphModel(
    ...
    morphType = Biomorph,
    descr =
      "Neo-porpoises are smaller but very similar to neo-dolphins and are much like their baseline relatives. They average 2.5 meters in length.",
    enhancements = Seq("Basic Biomods",
                       "Basic Mesh Inserts",
                       "Cortical Stack",
                       "Echolocation",
  ...
  val neotenic = MorphModel(
    ...
    morphType = Biomorph,
    descr =
      "Neotenics are transhumans modifed to retain a child-like form. They are smaller, more agile, inquisitive, and less resource-depleting, making them ideal for habitat living and spacecraft. Some people find neotenic sleeves distasteful, especially when employed in certain media and sex work capacities.",
    enhancements = Seq("Basic Biomods", "Basic Mesh Inserts", "Cortical Stack"),
