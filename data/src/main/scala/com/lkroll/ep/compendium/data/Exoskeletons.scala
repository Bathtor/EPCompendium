...
object Exoskeletons {
  ...
  val exowalker = Armour(
    name = "Exowalker",
    descr =
      "Exowalkers are minimal framework exoskeletons, primarily designed to bolster the wearer’s strength and movement. They provide a an Armor Value of 2/4, a +10 modifier to strength-based tests, and double the distance by which the character may jump.",
    armour = (2, 4),
    price = Cost.Moderate,
    source = Sources.ep,
    sourcePage = 344
  ...
  val hyperdenseExoskeleton = Armour(
    ...
    descr =
      "These powered exoskel- etons are larger (roughly twice human-sized) and built for heavy-use industrial purposes, such as handling heavy/large objects. The wearer is partially encapsulated to protect them from debris and industrial accidents. Hyperdense exoskeletons provide no movement bonus, but provide a +30 bonus to strength-based tests and inflict an extra +3d10 damage and –5 AP on physical attacks. They have an Armor Value of 6/12.",
    armour = (6, 12),
    price = Cost.Expensive,
    source = Sources.ep,
    sourcePage = 344
  ...
  val transporter = Armour(
    name = "Transporter",
    descr =
      "This exoskeleton framework includes a pair of vector-thrust turbofan engines, giving the user flight capabilities in gravity and increased maneuverability in zero g. It provides partial protection to the wearer with an Armor Value of 2/4. Piloted with Pilot: Aircraft skill.",
    armour = (2, 4),
    price = Cost.High,
    source = Sources.ep,
    sourcePage = 344
  ...
  val trike = Armour(
    name = "Trike",
    descr =
      "The trike exoskeleton is a three-wheeled personal motorcycle design, rather than a walker. It provides partial protection to the wearer with an Armor Value of 2/4. Piloted with Pilot: Groundrcraft skill.",
    armour = (2, 4),
    price = Cost.Moderate,
    source = Sources.ep,
    sourcePage = 344
