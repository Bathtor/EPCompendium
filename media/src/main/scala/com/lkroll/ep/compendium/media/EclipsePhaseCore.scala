...
object EclipsePhaseCore {
  ...
  val automaticRifles = multiImage(source = "IMG/Combat Rifle.jpg", caption = "An Automatic Rifle.")(
    ...
    KineticWeapons.automaticRifle.toRailgun
  );

  val cyberlimbs = multiImage(source = "IMG/Cyberlimb.jpg", caption = "A Morph with extra Cyberlimbs.")(
    Cyberware.cyberlimb,
  ...
  val lightPistols = multiImage(source = "IMG/Light Pistol.jpg", caption = "A Light Pistol.")(
    ...
    KineticWeapons.lightPistol.toRailgun
  );

  val limbers = multiImage(source = "IMG/Limber.jpg", caption = "A Morph with the Limber trait.")(
    TraitsPositiveEP.limber1,
    TraitsPositiveEP.limber2
  );

  val heavyPistols = multiImage(source = "IMG/Heavy Pistol.jpg", caption = "A Heavy Pistol.")(
    KineticWeapons.heavyPistol,
    KineticWeapons.heavyPistol.toRailgun
  );
  ...
  val sniperRifles = multiImage(source = "IMG/Sniper Rifle.jpg", caption = "A Railgun Sniper Rifle.")(
    ...
    KineticWeapons.sniperRifle.toRailgun
  );

  val submachineGuns = multiImage(source = "IMG/Submachine Gun.jpg", caption = "A Submachine Gun.")(
    KineticWeapons.submachineGun,
    KineticWeapons.submachineGun.toRailgun
  );
  ...
  val weaponAccessories =
    multiImage(source = "IMG/Weapon Accessories.jpg", caption = "A selection of Weapon Accessories.")(
      WeaponAccessories.extendedMagazine,
      WeaponAccessories.imagingScope,
      WeaponAccessories.laserSight,
      WeaponAccessories.silencer,
      WeaponAccessories.smartmag,
      WeaponAccessories.extsmartmag
    );
